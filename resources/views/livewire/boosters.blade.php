                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="booster-card card h-100">
                                <div class="booster-header text-center">
                                    ...
                                    <h5>Broadcast Task Badge</h5>
                                    <p class="text-muted small">Mark your tasks as broadcast</p>
                                </div>
                                <div class="card-body">
                                    <ul class="booster-features">
                                        <li><i class="bi bi-check text-success me-2"></i> "Broadcast" badge on your tasks</li>
...
<div class="content-wrapper">
    ...
    <div class="card mb-4">
        <div class="card-body d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h4 mb-0">Subscription Boosters</h1>
                <p class="text-muted mb-0">Choose the perfect booster for your needs</p>
            </div>
        </div>
    </div>
    ...
    <!-- Boosters Grid -->
    <div class="row g-4">
        @forelse($filteredBoosters as $booster)
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 {{ $booster['type'] === 'worker' ? 'border-primary' : 'border-success' }} position-relative">
                @if(in_array($booster['id'], $activeSubscriptionBoosterIds))
                ...
                <div class="card-body d-flex flex-column">
                    <div class="text-center mb-4">
                        <h5 class="card-title mb-2">{{ $booster['name'] }}</h5>
                        <p class="text-muted mb-3">{{ $booster['description'] }}</p>
                        
                        <div class="mb-3">
                            <span class="display-6 fw-bold text-primary">
                                {{ auth()->user()->country->currency_symbol }}{{ number_format($booster['monthly_price'], 2) }}
                            </span>
                    ...
                    <div class="mb-4 flex-grow-1">
                        ...
                        <ul class="list-unstyled">
                            @foreach($booster['features'] as $feature)
                                <li class="mb-2">
                    ...
                    <div class="mt-auto">
                        <button wire:click="chooseBooster('{{ $booster['slug'] }}')" 
                                class="btn btn-primary w-100">
                            <i class="ri-{{ in_array($booster['id'], $activeSubscriptionBoosterIds) ? 'refresh' : 'add' }}-line me-1"></i>
                            {{ in_array($booster['id'], $activeSubscriptionBoosterIds) ? 'Extend Subscription' : 'Choose Booster' }}
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">No subscription boosters are currently available for this type.</p>
                </div>
            </div>
        </div>
        @endforelse
    ...
    <!-- Subscription Modal -->
    @if($showModal && $selectedBooster)
    <div class="modal fade show" style="display: block;" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="ri-vip-crown-line me-2"></i>Subscribe to {{ $selectedBooster['name'] }}
                    </h5>
                        ...
                        <div class="col-md-6">
                            <div class="card border-primary">
                                ...
                                <div class="card-body">
                                    <div class="text-center mb-3">
                                        <span class="display-6 fw-bold text-primary">
                                            {{ auth()->user()->country->currency_symbol }}{{ number_format($selectedBooster['monthly_price'], 2) }}
                                        </span>
                                        <span class="text-muted">/month</span>
                                    </div>
                                    ...
                                    <h6 class="fw-semibold mb-3">Features:</h6>
                                    <ul class="list-unstyled">
                                        @foreach($selectedBooster['features'] as $feature)
                                            <li class="mb-2">
                                                <i class="ri-check-line text-success me-2"></i>
                                                <span class="small">{{ $feature }}</span>
                                            </li>
