...
<div class="alert alert-info d-flex justify-content-between align-items-center">
    <div>
        <strong>Current Booster:</strong> <span class="text-primary">{{ $workerSubscription->booster->name }}</span><br>
...
<div class="alert alert-info d-flex justify-content-between align-items-center">
    <div>
        ...
        <small>Choose a booster to start working on tasks.</small>
    </div>
    @if($workerUpgradeSuggestion)
    <div>
        <a href="{{ route('subscriptions') }}" class="btn btn-primary btn-sm">Get {{ $workerUpgradeSuggestion->name }} Booster</a>
    </div>
    @endif
</div>        
@endif
...
@if($workerPendingSubscription)
    <div class="alert alert-warning d-flex align-items-center">
        ...
        <div>
            <strong>Pending Subscription:</strong> Your <b>{{ $workerPendingSubscription->booster->name }}</b> booster will become active on {{ \Carbon\Carbon::parse($workerPendingSubscription->starts_at)->format('F d, Y') }}.
        </div>
    </div>
@endif
            ...
            <div class="col-md-3">
                <div class="card border-info">
                    <div class="card-body">
                        ...
                        <a href="{{route('tasks.applied')}}?status=saved" class="btn btn-link p-0">View all <i class="ri-arrow-right-line"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4 border-warning">
            <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                ...
                <a href="{{route('tasks.applied')}}?status=accepted" class="text-dark">View all <i class="ri-arrow-right-line"></i></a>
            </div>
            <div class="card-body">
        ...
        <div class="card border-success">
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{route('tasks.applied')}}?status=completed" class="text-white">View all <i class="ri-arrow-right-line"></i></a>
            </div>
            <div class="card-body">
