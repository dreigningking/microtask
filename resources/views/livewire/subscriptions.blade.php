    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-8 relative">
                ...
                <div class="text-primary text-xl font-bold mb-2"> {{ auth()->user()->country->currency_symbol }} {{ number_format($selectedPlan['monthly_price'], 2) }} <span class="text-base font-normal text-gray-500">/month</span></div>
                <ul class="mb-4 text-sm text-gray-700 list-disc ml-5">
                ...
                <button wire:click="subscribe" class="w-full bg-primary text-white py-2 px-4 rounded-button hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                    Subscribe
                </button>
            </div>
        </div>
