        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="mb-0 text-muted">Stay updated with your account activity</p>
                </div>
                    ...
                    <div class="list-group list-group-flush">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-1">
                                        <span class="badge bg-primary me-2">Task</span>
                                        <small class="text-muted">2 hours ago</small>
                                    </div>
                                    <h6 class="mb-1">New task matches your skills: "Social Media Manager"</h6>
                                    <p class="mb-1 text-muted">A new task in Social Media category matches your profile. Budget: $75</p>
                                    <div class="mt-2">
                                        <a href="tasks.html" class="btn btn-sm btn-outline-primary me-2">View Task</a>
                        ...
                        <div class="list-group-item unread-notification">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h6 class="mb-1">Your withdrawal was processed</h6>
                                    <p class="mb-1 text-muted">$100 has been sent to your bank account (Access Bank •••• 4821)</p>
                                    <div class="mt-2">
                                        <a href="earnings.html" class="btn btn-sm btn-outline-primary me-2">View Earnings</a>
                                        <button class="btn btn-sm btn-outline-secondary mark-read">Mark as Read</button>
                                    </div>
                                </div>
                                <i class="bi bi-circle-fill text-primary"></i>
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h6 class="mb-1">You have a new message from Sarah Johnson</h6>
                                    <p class="mb-1 text-muted">Regarding the "Logo Design" task you applied for</p>
                                    <div class="mt-2">
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-1">
                                        <span class="badge bg-warning me-2">System</span>
                                        <small class="text-muted">3 days ago</small>
                                    </div>
                                    <h6 class="mb-1">System maintenance scheduled</h6>
                                    <p class="mb-1 text-muted">The platform will be unavailable on October 20th, 2:00 AM - 4:00 AM for maintenance</p>
                                </div>
                            </div>
                        </div>
                    </div>
