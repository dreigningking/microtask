    ...
    <form wire:submit.prevent="submitJob" class="space-y-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="form-check">
                            <input type="radio" id="selfMonitored" wire:model="monitoring_type" wire:change="updateTotals" value="self_monitoring" class="form-check-input" {{ $monitoring_type === 'self_monitoring' ? 'checked' : '' }} @if(!$canEdit) disabled @endif>
                            <label for="selfMonitored" class="form-check-label">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="badge bg-warning mt-1">{{ $currency_symbol }}{{ number_format($countrySetting->admin_monitoring_cost ?? 0, 2) }}</div>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input type="radio" id="adminMonitored" wire:model="monitoring_type" wire:change="updateTotals" value="admin_monitoring" class="form-check-input" {{ $monitoring_type === 'admin_monitoring' ? 'checked' : '' }} @if(!$canEdit) disabled @endif>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input type="radio" id="systemMonitored" wire:model="monitoring_type" wire:change="updateTotals" value="system_monitoring" class="form-check-input" {{ $monitoring_type === 'system_monitoring' ? 'checked' : '' }} @if(!$canEdit) disabled @endif>
                            <label for="systemMonitored" class="form-check-label">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="badge bg-info mt-1">{{ $currency_symbol }}{{ number_format($countrySetting->system_monitoring_cost ?? 0, 2) }}</div>
                                    </div>
                                </div>
                            </label>
                        </div>
                ...
                @error('monitoring_type') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border-light">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="form-check me-3">
                                        <input id="urgent" type="checkbox" wire:model="urgent" wire:change="updateTotals" class="form-check-input" @if(!$canEdit) disabled @endif>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="small fw-medium">{{ $currency_symbol }} {{ number_format($monitoring_fee, 2) }}</span>
                            </div>
