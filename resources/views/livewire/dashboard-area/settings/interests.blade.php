<div>
    ...
    @if(count($userLocations) > 0 && empty($selected_platforms))
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            <strong>Heads up!</strong> You've added locations, but you won't receive notifications until you select at least one platform interest.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">
                        <i class="ri-apps-line me-2"></i>Platform Interests
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row g-2">
                    ...
                    <div class="mt-3">
                        <button wire:click="savePlatformInterests" class="btn btn-primary">
                            <i class="ri-save-line me-1"></i>Save Platform Interests
                        </button>
                    </div>
                </div>
            </div>
