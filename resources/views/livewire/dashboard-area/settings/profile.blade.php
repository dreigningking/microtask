    ...
    <div x-data="{ open: false, activeSection: 'basic' }" class="lg:flex lg:space-x-8">
        ...
        <div class="lg:w-1/4">
            ...
            <nav :class="{'block': open, 'hidden': !open}" class="lg:block bg-white rounded-lg shadow p-4 dark:bg-gray-800">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="#" @click.prevent="activeSection = 'notifications'" :class="{'bg-primary text-white': activeSection === 'notifications', 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700': activeSection !== 'notifications'}" class="flex items-center px-4 py-2 rounded-lg text-sm font-medium">
        ...
        <div class="lg:w-3/4 mt-8 lg:mt-0">
            ...
            <div x-show="activeSection === 'password'" style="display: none;">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-4">Security</h2>
                @livewire('dashboard-area.settings.security')
            </div>
            
            <div x-show="activeSection === 'notifications'" style="display: none;">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-4">Notification Settings</h2>
