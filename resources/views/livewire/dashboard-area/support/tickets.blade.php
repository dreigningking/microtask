            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="btn-group">
                        ...
                        <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#newTicketModal">
        ...
        <div class="container">
                ...
                <div class="col-md-4">
                    <div class="card text-center h-100">
                        <div class="card-body">
                            ...
                            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#newTicketModal">
                                Create Ticket
                            </button>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-primary">2 Open Tickets</span>
                </div>
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <h6 class="mb-1">Withdrawal Processing Delay</h6>
                                    <span class="badge bg-warning">In Progress</span>
                                </div>
                                <p class="mb-1 text-muted">My withdrawal request from October 10th is still processing...</p>
                                <small class="text-muted">Last updated: October 12, 2023 • Ticket #78945</small>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <h6 class="mb-1">Task Application Issue</h6>
                                    <span class="badge bg-success">Resolved</span>
                                </div>
                                <p class="mb-1 text-muted">Unable to apply for tasks due to system error...</p>
                                <small class="text-muted">Last updated: October 5, 2023 • Ticket #78412</small>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-1 text-muted">Need help with document verification for my account...</p>
                                <small class="text-muted">Last updated: September 28, 2023 • Ticket #77369</small>
                            </div>
                        </div>
                    </div>
                </div>
