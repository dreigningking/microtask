            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="dashboard-card card mb-4 position-relative">
                        <span class="subscription-badge badge bg-warning text-dark">Basic Plan</span>
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="card-title">Current Subscription: Basic Plan</h5>
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="subscriptions.html" class="btn btn-primary">Upgrade Plan</a>
                                </div>
                            </div>
                        </div>
                    </div>
