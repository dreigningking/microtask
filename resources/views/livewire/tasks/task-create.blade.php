                        ...
                        <div class="wizard-step" id="step3">
                            <div class="form-card card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="promotion-card">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="autoReview">
                                    ...
                                    <div class="mb-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="broadcastBadge">
                                            <label class="form-check-label fw-bold" for="broadcastBadge">
                                                Broadcast Badge Promotion
                                            </label>
                                        </div>
                                        <div class="form-text">Add an "Broadcast" badge to your task for $10</div>
                                    </div>
