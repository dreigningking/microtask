            ...
            <div class="row align-items-center">
                <div class="col-md-8">                
                    ...
                    <div class="d-flex align-items-center text-white-50">
                        ...
                        <span><i class="bi bi-clock"></i>  {{ $task->remaining_time }} left</span>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="d-flex justify-content-between">
                                <button class="btn btn-sm btn-primary"><i class="bi bi-share"></i> Share via email</button>
                    ...
                    <ul class="nav nav-tabs mb-4" id="submissionsTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="comments-tab" data-bs-toggle="tab" data-bs-target="#comments" type="button">
                                Comments <span class="badge bg-primary ms-1">5</span>
                            </button>
                        </li>
                    </ul>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <div class="d-flex align-items-center">
                                            <img src="https://placehold.co/40" alt="Worker" class="rounded-circle me-3">
                                            <div>
                                ...
                                <div class="comment-thread card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3">
                                            <img src="https://placehold.co/40" alt="User" class="rounded-circle me-3">
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Can I use stock photos or do I need to create original content for the Instagram posts?</p>
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-hand-thumbs-up me-1"></i> Helpful (3)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>

                                        <!-- Task Creator Response -->
                                        <div class="response ms-5 border-start border-primary border-3 ps-3 mb-3">
                                            <div class="d-flex mb-2">
                                                <img src="https://placehold.co/35" alt="Task Creator" class="rounded-circle me-2">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <h6 class="mb-0 me-2">You</h6>
                                                        <span class="badge bg-primary">Author</span>
                                                        <small class="text-muted ms-2">1 hour ago</small>
                                                    </div>
                                                    <p class="mb-0">Original content is preferred, but high-quality stock photos that match our brand aesthetic are acceptable. Please ensure they align with our coffee shop theme and brand colors.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="response-form ms-5 border-start border-primary border-3 ps-3">
                                            <form>
                                                <div class="mb-2">
                                                    <textarea class="form-control form-control-sm" rows="2" placeholder="Add another response..."></textarea>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">What file format should I use for the images? And what's the exact pixel dimensions needed?</p>
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-hand-thumbs-up me-1"></i> Helpful (1)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <h6 class="mb-0 me-2">You</h6>
                                                        <span class="badge bg-primary">Author</span>
                                                        <small class="text-muted ms-2">3 hours ago</small>
                                                    </div>
                                                    <p class="mb-0">Please use JPEG or PNG format. The exact dimensions should be 1080x1080 pixels (square format for Instagram). Make sure the images are high resolution for best quality.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Do you have any specific hashtags you'd like me to include, or should I create my own based on coffee culture?</p>
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-hand-thumbs-up me-1"></i> Helpful (2)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <h6 class="mb-0 me-2">You</h6>
                                                        <span class="badge bg-primary">Author</span>
                                                        <small class="text-muted ms-2">5 hours ago</small>
                                                    </div>
                                                    <p class="mb-0">Feel free to create relevant hashtags based on coffee culture. Some suggestions: #CoffeeShop, #BrewedWithLove, #CoffeeCulture, #LocalCoffee, #CoffeeLovers. Make sure they're relevant and not overused.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Is there a specific tone or voice I should use for the captions? Should they be formal, casual, or something else?</p>
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-hand-thumbs-up me-1"></i> Helpful (4)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <h6 class="mb-0 me-2">You</h6>
                                                        <span class="badge bg-primary">Author</span>
                                                        <small class="text-muted ms-2">7 hours ago</small>
                                                    </div>
                                                    <p class="mb-0">We want a warm, inviting, and approachable tone. Think friendly neighborhood coffee shop - not too formal, but not overly casual either. Focus on creating a sense of community and comfort around coffee.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">How many posts should I create for this task? The description mentions 5, but I want to make sure.</p>
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-hand-thumbs-up me-1"></i> Helpful (1)
                                                    </button>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <h6 class="mb-0 me-2">You</h6>
                                                        <span class="badge bg-primary">Author</span>
                                                        <small class="text-muted ms-2">20 hours ago</small>
                                                    </div>
                                                    <p class="mb-0">Yes, exactly 5 Instagram posts are needed for this task. Each post should be complete with image, caption, and relevant hashtags.</p>
                                                </div>
                                            </div>
                                        </div>
...
<div class="d-flex align-items-center gap-3 text-muted">
    <span><i class="fa fa-clock me-1"></i>Posted </span>
    @if($task->expiry_date)
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <h6 class="text-muted mb-2">Review Type</h6>
                        <p class="fw-semibold mb-0">{{ ucfirst($task->review_type) }}</p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <h6 class="text-muted mb-2">Review Frequency</h6>
                        <p class="fw-semibold mb-0">{{ ucfirst($task->review_frequency) }}</p>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-success">Completed</span>
                                    @elseif($selectedSubmission->dispute)
                                    @if($selectedSubmission->dispute->resolved_at)
                                    <span class="badge bg-info">Dispute Resolved</span>
                                    @else
                                    <span class="badge bg-warning">Disputed</span>
                                    @endif
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <small class="text-muted">Disputed on {{ $selectedSubmission->dispute->created_at->format('M d, Y H:i') }}</small>
                            </div>
                            @else
                            <span class="badge bg-info">Pending Review</span>
                            @endif
