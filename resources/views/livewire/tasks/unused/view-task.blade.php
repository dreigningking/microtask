<div class="content-wrapper">
    ...
    <div class="card mb-4">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                @endif
                <span class="badge bg-success fs-6">{{ $taskWorker->task->user->currency_symbol ?? '$' }}{{ number_format($taskWorker->task->budget_per_submission, 2) }}</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span class="bg-primary bg-opacity-10 rounded-circle p-2">
                            ...
                            @elseif($taskWorker->submitted_at)
                            <i class="ri-send-boostere-line text-warning"></i>
                            @elseif($taskWorker->accepted_at)
        ...
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <h3 class="fw-bold mb-0">{{ $taskWorker->task->user->currency_symbol ?? '$' }}{{ number_format($taskWorker->task->budget_per_submission, 2) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary w-100">
                                    <i class="ri-send-boostere-line me-1"></i> Submit Task
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <a href="{{ route('tasks.applied') }}" class="btn btn-primary">
