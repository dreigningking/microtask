<div class="content-wrapper">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label for="average_completion_minutes" class="form-label fw-medium mb-1">Average Completion Time <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="number" id="average_completion_minutes" wire:model="average_completion_minutes" min="1" class="form-control {{ $errors->has('average_completion_minutes') ? 'is-invalid' : '' }}" placeholder="e.g. 3" required>
    ...
    <!--Step 3: Budget, Expiry, Review, Promotion -->
    @if($currentStep == 3)
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="review-option">
                            <input type="radio" id="selfMonitored" wire:model="review_type" wire:change="updateTotals" value="self_review" class="btn-check" {{ $review_type === 'self_review' ? 'checked' : '' }}>
                            <label for="selfMonitored" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center p-3 {{ $review_type === 'self_review' ? 'active' : '' }}">
                                ...
                                <span class="badge bg-warning mt-2">{{ $currency_symbol }}{{ number_format($countrySetting->admin_review_cost ?? 0, 2) }}</span>
                    ...
                    <div class="col-md-4">
                        <div class="review-option">
                            <input type="radio" id="adminMonitored" wire:model="review_type" wire:change="updateTotals" value="admin_review" class="btn-check" {{ $review_type === 'admin_review' ? 'checked' : '' }}>
                            <label for="adminMonitored" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center p-3 {{ $review_type === 'admin_review' ? 'active' : '' }}">
                                <div class="w-10 h-10 bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center mb-2">
                    ...
                    <div class="col-md-4">
                        <div class="review-option">
                            <input type="radio" id="systemMonitored" wire:model="review_type" wire:change="updateTotals" value="system_review" class="btn-check" {{ $review_type === 'system_review' ? 'checked' : '' }}>
                            <label for="systemMonitored" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center p-3 {{ $review_type === 'system_review' ? 'active' : '' }}">
                                <div class="w-10 h-10 bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center mb-2">
                                ...
                                <span class="badge bg-info mt-2">{{ $currency_symbol }}{{ number_format($countrySetting->system_review_cost ?? 0, 2) }}</span>
                            </label>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border-light">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="form-check me-3">
                                        <input id="broadcast" type="checkbox" wire:model="broadcast" wire:change="updateTotals" class="form-check-input ms-0">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="small fw-medium">
                                    {{ $currency_symbol }} {{ number_format($review_fee, 2) }}
                                    @if($review_type === 'admin_review' || $review_type === 'system_review')
                                    <span class="small text-muted">({{ $currency_symbol }}{{ number_format($review_fee / $number_of_submissions, 2) }} x {{ $number_of_submissions }} submissions)</span>
                                    @endif
                                </span>
                            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                @if($broadcast)
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="small text-muted">Broadcast Badge ({{ $number_of_submissions }} submissions):</span>
                                    <span class="fw-medium">
                                        @if($broadcastPrice == 0)
                                        <span class="text-success">Included</span>
                                        @else
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="small text-muted">Review Fee:</span>
                                    <span class="fw-medium">{{ $currency_symbol }} {{ number_format($review_fee, 2) }}</span>
                                </div>
                                @if($showSystemReviewRefundNote)
                                <div class="small text-primary mt-1 ms-2">
                                    <i class="ri-information-line me-1"></i>This fee will be refunded if no admin intervention is required
...
<style>
    ...
    .review-option .btn-check:checked+.btn .bg-primary {
        background-color: #0d6efd !important;
    }

    .review-option .btn-check:checked+.btn .text-primary {
        color: #0d6efd !important;
    }
