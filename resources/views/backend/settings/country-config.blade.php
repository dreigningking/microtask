                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <select class="form-control" name="bank_account_storage" id="bank_account_storage">
                                                                <option value="on_premises" {{ old('bank_account_storage', $settings->banking_settings['bank_account_storage'] ?? 'on_premises') == 'on_premises' ? 'selected' : '' }}>On-Premises</option>
                                                                <option value="off_premises" {{ old('bank_account_storage', $settings->banking_settings['bank_account_storage'] ?? 'on_premises') == 'off_premises' ? 'selected' : '' }}>Off-Premises (Gateway)</option>
                                                            </select>
                                                        ...
                                                        <div class="mb-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" name="account_length" value="{{ old('account_length', $settings->banking_settings['account_length'] ?? 10) }}">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox" id="bank_verification_required" name="bank_verification_required" {{ old('bank_verification_required', $settings->banking_settings['require_account_verification'] ?? false) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <select class="form-control" name="bank_verification_method">
                                                                <option value="manual" {{ old('bank_verification_method', $settings->banking_settings['account_verification_method'] ?? 'manual') == 'manual' ? 'selected' : '' }}>Manual Verification</option>
                                                                <option value="gateway" {{ old('bank_verification_method', $settings->banking_settings['account_verification_method'] ?? 'manual') == 'gateway' ? 'selected' : '' }}>Gateway Verification</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control" name="usd_exchange_rate_percentage" value="{{ old('usd_exchange_rate_percentage', $settings->wallet_settings['usd_exchange_rate'] ?? 0) }}" step="0.0001">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="row mb-2">
                                                            <div class="col-md-5">
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control" name="transaction_percentage" value="{{ $settings->transaction_settings['charges']['percentage'] ?? 2 }}" step="0.01">
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" class="form-control" name="transaction_fixed" value="{{ $settings->transaction_settings['charges']['fixed'] ?? 100 }}" step="0.01">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text">{{ $country->currency_symbol }}</span>
                                                            <input type="number" class="form-control" name="transaction_cap" value="{{ $settings->transaction_settings['charges']['cap'] ?? 2000 }}" step="0.01">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-2">
                                                                    <input type="number" class="form-control" name="tax_percentage" value="{{ $settings->transaction_settings['tax']['percentage'] ?? 0 }}" step="0.01">
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox" id="tax_apply" name="tax_apply" {{ ($settings->transaction_settings['tax']['apply'] ?? false) ? 'checked' : '' }}>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="input-group mb-2">
                                                                    <input type="number" class="form-control" name="withdrawal_percentage" value="{{ $settings->withdrawal_settings['charges']['percentage'] ?? 1 }}" step="0.01">
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-7">
                                                                <div class="input-group mb-2">
                                                                    <span class="input-group-text">{{ $country->currency_symbol }}</span>
                                                                    <input type="number" class="form-control" name="withdrawal_fixed" value="{{ $settings->withdrawal_settings['charges']['fixed'] ?? 50 }}" step="0.01">
                                                                    <span class="input-group-text">Fixed</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-text">{{ $country->currency_symbol }}</span>
                                                            <input type="number" class="form-control" name="withdrawal_cap" value="{{ $settings->withdrawal_settings['charges']['cap'] ?? 1000 }}" step="0.01">
                                                            <span class="input-group-text">Cap</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text">{{ $country->currency_symbol }}</span>
                                                            <input type="number" class="form-control" name="min_withdrawal" value="{{ old('min_withdrawal', $settings->withdrawal_settings['min_withdrawal'] ?? 10) }}" step="0.01">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text">{{ $country->currency_symbol }}</span>
                                                            <input type="number" class="form-control" name="max_withdrawal" value="{{ old('max_withdrawal', $settings->withdrawal_settings['max_withdrawal'] ?? 5000) }}" step="0.01">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="form-check mr-auto">
                                                                <input class="form-check-input" type="radio" name="wallet_status" id="enable_wallets" value="enabled" {{ old('wallet_status', ($settings->wallet_settings['wallet_status'] ?? true) ? 'enabled' : 'disabled') == 'enabled' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="enable_wallets">
                                                                    Enable Wallets
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="wallet_status" id="disable_wallets" value="disabled" {{ old('wallet_status', ($settings->wallet_settings['wallet_status'] ?? true) ? 'enabled' : 'disabled') == 'disabled' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="form-check form-switch mb-2">
                                                            <input class="form-check-input" type="checkbox" id="weekend_payout" name="weekend_payout" {{ ($settings->withdrawal_settings['weekend_payout'] ?? false) ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="weekend_payout">Weekend Payout</label>
                                                        </div>

                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="holiday_payout" name="holiday_payout" {{ ($settings->withdrawal_settings['holiday_payout'] ?? false) ? 'checked' : '' }}>
