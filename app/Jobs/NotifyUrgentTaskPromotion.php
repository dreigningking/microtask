...
class NotifyUrgentTaskPromotion implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $userLocationIds = UserLocation::where('country_id', $countryId)->pluck('user_id')->toArray();
        if (empty($userLocationIds)) return;
