    ...
    public function run(): void
    {
        $platforms = [
            [
                ...
                'image' => '/storage/platforms/facebook.jpg',
                'is_active' => true,
            ],
            [
                'name' => 'Twitter',
                ...
                'image' => '/storage/platforms/twitter.png',
                'is_active' => true,
            ],
            [
                'name' => 'Instagram',
                ...
                'image' => '/storage/platforms/instagram.jpg',
                'is_active' => true,
            ],
            [
                'name' => 'WhatsApp',
                ...
                'image' => '/storage/platforms/whatsapp.jpg',
                'is_active' => true,
            ],
            [
                'name' => 'YouTube',
                ...
                'image' => '/storage/platforms/youtube.jpg',
                'is_active' => true,
            ],
            [
                'name' => 'LinkedIn',
                ...
                'image' => '/storage/platforms/linkedin.png',
                'is_active' => true,
            ],
            [
                'name' => 'TikTok',
                ...
                'image' => '/storage/platforms/tiktok.jpg',
                'is_active' => true,
            ],
            [
                'name' => 'Custom Website',
                ...
                'image' => '/storage/platforms/custom.jpg',
                'is_active' => true,
            ],
            [
                'name' => 'Mobile Games',
