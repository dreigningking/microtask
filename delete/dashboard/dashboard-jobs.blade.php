...
<div class="alert alert-primary d-flex justify-content-between align-items-center">
    <div>
        <strong>Current Booster:</strong> <span class="text-primary">{{ $taskmasterSubscription->booster->name }}</span><br>
...
<div class="alert alert-primary d-flex justify-content-between align-items-center">
    <div>
        ...
        <small>Choose a booster to start posting jobs.</small>
    </div>
    @if($taskmasterUpgradeSuggestion)
    <div>
        <a href="{{ route('subscriptions') }}" class="btn btn-primary btn-sm">Get {{ $taskmasterUpgradeSuggestion->name }} Booster</a>
    </div>
    @endif
</div>        
@endif
...
@if($taskmasterPendingSubscription)
    <div class="alert alert-warning d-flex align-items-center">
        ...
        <div>
            <strong>Pending Subscription:</strong> Your <b>{{ $taskmasterPendingSubscription->booster->name }}</b> booster will become active on {{ \Carbon\Carbon::parse($taskmasterPendingSubscription->starts_at)->format('F d, Y') }}.
        </div>
    </div>
@endif
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4 border-success">
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{route('tasks.create')}}" class="text-white">Post a new job <i class="ri-add-line"></i></a>
            </div>
            <div class="card-body">
                ...
                @empty
                <div class="text-center text-muted">You haven't posted any jobs yet.<br><a href="{{route('tasks.create')}}" class="btn btn-link">Post your first job</a></div>
                @endforelse
            </div>
        </div>
        <!-- Recent Submissions -->
        <div class="card border-primary">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                    ...
                    <a href="{{route('tasks.manage',$submission->task)}}" class="btn btn-sm btn-success">Review Submission</a>
                </div>
                @empty
